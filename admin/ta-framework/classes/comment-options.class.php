 ...
 *
 */
if ( ! class_exists( 'TAF_Comment_Metabox' ) ) {
  class TAF_Comment_Metabox extends TAF_Abstract{
            ...
            foreach ( $this->sections as $section ) {
              ...
              if ( ! empty( $section['fields'] ) ) {
                ...
                foreach ( $section['fields'] as $field ) {
                  ...
                  TAF::field( $field, $this->get_meta_value( $comment->comment_ID, $field ), $this->unique, 'comment_metabox' );
