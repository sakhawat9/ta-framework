 ...
 *
 */
if ( ! class_exists( 'TAF_Customize_Options' ) ) {
  class TAF_Customize_Options extends TAF_Abstract {
    ...
    public function add_customize_options( $wp_customize ) {
      ...
      if ( ! class_exists( 'WP_Customize_Panel_TAF' ) ) {
        TAF::include_plugin_file( 'functions/customize.php'  );
      }
      ...
      foreach ( $this->pre_sections as $section ) {
        ...
        if ( ! empty( $section['subs'] ) ) {
          ...
          $wp_customize->add_panel( new WP_Customize_Panel_TAF( $wp_customize, $panel_id, array(
    ...
    public function add_section( $wp_customize, $section_id, $section_args, $panel_id ) {
      ...
      if ( ! empty( $section_args['assign'] ) ) {
        ...
        $wp_customize->add_section( new WP_Customize_Section_TAF( $wp_customize, $section_id, array(
      ...
      if ( ! empty( $section_args['fields'] ) ) {
        ...
        foreach ( $section_args['fields'] as $field ) {
          ...
          $wp_customize->add_control( new WP_Customize_Control_TAF( $wp_customize, $setting_id,
