 ...
 *
 */
if ( ! class_exists( 'TAF_Nav_Menu_Options' ) ) {
  class TAF_Nav_Menu_Options extends TAF_Abstract{
    ...
    public function wp_edit_nav_menu_walker( $class, $menu_id ) {
      ...
      if( version_compare( $wp_version, '5.4.0', '<' ) ) {
        ...
        if ( ! class_exists( 'TAF_Walker_Nav_Menu_Edit' ) ) {
          TAF::include_plugin_file( 'functions/walker.php' );
        }

        return 'TAF_Walker_Nav_Menu_Edit';
        ...
        foreach ( $this->sections as $section ) {
          ...
          if ( ! empty( $section['fields'] ) ) {
            ...
            foreach ( $section['fields'] as $field ) {
              ...
              TAF::field( $field, $this->get_meta_value( $menu_item_id, $field ), $this->unique .'['. $menu_item_id .']', 'menu' );
