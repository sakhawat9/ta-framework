 ...
 *
 */
if ( ! class_exists( 'TAF_Profile_Options' ) ) {
  class TAF_Profile_Options extends TAF_Abstract{
      ...
      foreach ( $this->sections as $section ) {
        ...
        if ( ! empty( $section['fields'] ) ) {
          ...
          foreach ( $section['fields'] as $field ) {
            ...
            TAF::field( $field, $this->get_meta_value( $profile_id, $field ), $this->unique, 'profile' );
