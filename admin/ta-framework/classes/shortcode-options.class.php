 ...
 *
 */
if ( ! class_exists( 'TAF_Shortcoder' ) ) {
  class TAF_Shortcoder extends TAF_Abstract{
    ...
    public function __construct( $key, $params = array() ) {
      ...
      if ( ! empty( $this->args['show_in_editor'] ) ) {
        ...
        TAF::$shortcode_instances[] = wp_parse_args( array( 'name' => 'taf/'. $name, 'modal_id' => $this->unique ), $this->args );

        // elementor editor support
        if ( TAF::is_active_plugin( 'elementor/elementor.php' ) ) {
          add_action( 'elementor/editor/before_enqueue_scripts', array( 'TAF', 'add_admin_enqueue_scripts' ) );
          add_action( 'elementor/editor/footer', array( 'TAF_Field_icon', 'add_footer_modal_icon' ) );
        ...
        <div class="taf-modal-table">
          <div class="taf-modal-table-cell">
            ...
            <div class="taf-modal-inner">
              ...
              <div class="taf-modal-insert-wrapper hidden"><a href="#" class="button button-primary taf-modal-insert"><?php echo esc_html($this->args['insert_title']); ?></a></div>
            </div>
          </div>
        </div>
      </div>
        ...
        if ( ! empty( $section ) ) {
          ...
          if ( ! empty( $section['fields'] ) && $view !== 'repeater' ) {
            ...
            foreach ( $section['fields'] as $field ) {
              ...
              TAF::field( $field, $field_default, $shortcode, 'shortcode' );
          ...
          if ( ! empty( $repeatable_fields ) ) {
            ...
            echo '<div class="taf--repeatable">';
              ...
              echo '<div class="taf--repeat-shortcode">';
                ...
                foreach ( $repeatable_fields as $field ) {
                  ...
                  TAF::field( $field, $field_default, $inner_shortcode.'[0]', 'shortcode' );
            ...
            echo '<div class="taf--repeat-button-block"><a class="button taf--repeat-button" href="#"><i class="fas fa-plus-circle"></i> '. esc_html($button_title) .'</a></div>';
    ...
    public static function once_editor_setup() {
      ...
      if ( function_exists( 'register_block_type' ) ) {
        add_action( 'enqueue_block_editor_assets', array( 'TAF_Shortcoder', 'add_guteberg_blocks' ) );
      }

      if ( taf_wp_editor_api() ) {
        add_action( 'media_buttons', array( 'TAF_Shortcoder', 'add_media_buttons' ) );
      }
    ...
    public static function add_guteberg_blocks() {
      ...
      wp_enqueue_script( 'taf-gutenberg-block', TAF::include_plugin_url( 'assets/js/gutenberg.js' ), $depends );

      wp_localize_script( 'taf-gutenberg-block', 'taf_gutenberg_blocks', TAF::$shortcode_instances );

      foreach ( TAF::$shortcode_instances as $block ) {
    ...
    public static function add_media_buttons( $editor_id ) {
      ...
      foreach ( TAF::$shortcode_instances as $value ) {
