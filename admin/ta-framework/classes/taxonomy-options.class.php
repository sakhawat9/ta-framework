 ...
 *
 */
if ( ! class_exists( 'TAF_Taxonomy_Options' ) ) {
  class TAF_Taxonomy_Options extends TAF_Abstract{
        ...
        if ( $taxonomy === $this->taxonomy ) {
          ...
          if ( ! empty( $section['fields'] ) ) {
            foreach ( $section['fields'] as $field ) {
              ...
              TAF::field( $field, $this->get_meta_value( $field, $term_id ), $this->unique, 'taxonomy' );
