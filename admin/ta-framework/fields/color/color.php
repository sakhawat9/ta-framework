 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'TAF_Field_color' ) ) {
	class TAF_Field_color extends TAF_Fields {
		...
		public function render() {
			...
			echo '<input type="text" name="' . esc_attr( $this->field_name() ) . '" value="' . esc_attr( $this->value ) . '" class="taf-color"' . $default_attr . $this->field_attributes() . '/>';
